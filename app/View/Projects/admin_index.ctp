  ...
  <div class="card">
    <div class="card-header">
      ...
      <div class="card-tools">
        <a href="/admin/projects/add?lang=ru" class="btn  btn-success">Добавить новый материал</a>
      </div>
            ...
            <tbody>
                  ...
                  <?php endforeach; ?>
    					...
    					<td class="project-actions text-right">
    						<a class="btn btn-info btn-sm" href="/admin/projects/edit/<?=$item['Project']['id']?>?lang=ru">
    							<i class="fas fa-pencil-alt">
    							</i>
    							Рус
    						</a>
                <a class="btn btn-info btn-sm" href="/admin/projects/edit/<?=$item['Project']['id']?>?lang=kz">
                  <i class="fas fa-pencil-alt">
                  </i>
                  Кз
                </a>
