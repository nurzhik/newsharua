                ...
                <div class="links-content padding-0">
                        ...
                        <?php foreach ($questions as $key => $item): ?>
                            <div class="oprosnik-inner__item padding-st padding-t-b">
                                ...
                                <div class="opros-radio">
                                    <label for="q<?=$key?>a1">
                                        <input type="radio" id="q<?=$key?>a1" required name="data[Question][results][q<?=$key+1?>][answer]" value="Поддерживаю">
                                        <span>Поддерживаю</span>
                                    </label>
                                    <label for="q<?=$key?>a2">
                                        <input type="radio" id="q<?=$key?>a2" required name="data[Question][results][q<?=$key+1?>][answer]" value="Не поддерживаю">
                                        <span>Не поддерживаю</span>
                                    </label>
                                    <label for="q<?=$key?>a3">
                                        <input type="radio" id="q<?=$key?>a3"   required name="data[Question][results][q<?=$key+1?>][answer]" value="Воздерживаюсь от голоса">
                    ...
                    <?php else: ?>
                        <a href="/<?=$lang?>users/my_questionnaires" class="before-page padding-st"> 
                            ...
                            <?php foreach ($results['Result']['results'] as $k => $q1): ?>
                                <div class="oprosnik-inner__item padding-st padding-t-b">
